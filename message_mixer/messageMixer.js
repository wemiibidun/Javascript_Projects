//The aim of this project is to create a messaging service that allows you to perform an action on input text and display the output of that behavior to the console
//const MessageMixer = {};
...
//Created function palindrome and piglatin
...
//exported each of the functions as a variable
